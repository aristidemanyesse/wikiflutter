...
class LeagueTeamsrankingCard extends StatelessWidget {
    ...
    return Card(
      ...
      child: ClipRRect(
        ...
        child: SizedBox(
            ...
            child: Obx(() {
              List<LigneRanking> ranks = [];
              ranks =
                  controller.rankingSelected.value.rankingLignes!.sublist(0);
              ...
              return DataTable(
                ...
                columns: const [
                  ...
                  DataColumn(label: Text("MJ", style: AppTextStyle.titleSmall)),
                  DataColumn(
